...
#         print(Total_Activity.head())
        ...
        print(List_of_DataFrames[0].mo99[10],List_of_DataFrames[1].mo99[10], Total_Activity.mo99[10])
#         print(Total_Activity.head())
        time1 = time.time()
        ...
        try:
            ...
            print("Error Saving excel file, please close open files. Reattempting save in 10 seconds")
            time.sleep(10)

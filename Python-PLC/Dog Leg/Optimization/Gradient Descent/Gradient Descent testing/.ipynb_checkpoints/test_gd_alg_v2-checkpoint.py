...
epsilon1 = 0.05 *min(xmax-xmin, ymax-ymin)
...
while True:
    try:
        outputs = gd_iteration(f_FOM, x_track, f_track, grad_track, grad_norm_track, alpha_track, i, limits, epsilon1, m)
        ...
        # Convergence checks
        x_diff, convergence = converge_v1(x_track, epsilon1, limits) # check criteria 1
        if convergence == True:
            break

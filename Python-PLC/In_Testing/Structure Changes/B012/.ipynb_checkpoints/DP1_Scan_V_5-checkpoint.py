...
Tunnel, PLC_IP, os_address, Runs, Step_Size, count, Oscope = M.config_reader('dp1_scan_config.txt', "Dipole Scan")
...
fig.savefig(f"{now}_graph.{plot_type}", dpi = 450, transparent = True)
...
workbook = xlsxwriter.Workbook(f'{now}_DP1_scan.xlsx',  {'nan_inf_to_errors': True})

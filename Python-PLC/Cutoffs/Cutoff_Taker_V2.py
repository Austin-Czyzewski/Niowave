...
################################################################
Slider_Bar_Setpoint = M.Read(Client, Tags.BH_VVA_SP) #new

print(Slider_Bar_Setpoint) #new
...
filename = now + "_Cutoffs" + ".txt"

with open(filename,'w') as f:
    f.write("Time, V0 Request, CU Gun Pt, Cu Gun V, BH Pt, V0 Readback, Emitted Current, Cu Gun Temp, Cathode Power Readback, BH OC Temp, Cu Gun Water Return Temp\n")
...
M.Write(Client, Tags.V0_VVA_SP, Slider_Bar_Setpoint * Ratio_From_Start) # new
